...
const steps: TooltipStep[] = [
    {
        id: 'step-1',
        targetId: 'tuto-settings',
        title: '1. Réglages',
        description: 'Personnalisez la police, le format, la signature et les filtres d\'image de vos créations.',
        position: 'bottom',
        offset: { x: 0, y: 16 },
    },
    {
        id: 'step-2',
        targetId: 'tuto-categories',
        title: '2. Choisissez une catégorie',
        description: 'Coran, Hadith, Douas, Ramadan, Rabbana ou un Thème libre — sélectionnez la source de votre rappel.',
        position: 'top',
        offset: { x: 0, y: -170 },
    },
    {
        id: 'step-3',
        targetId: 'tuto-topic',
        title: '3. Précisez un thème',
        description: 'Tapez un mot-clé (patience, gratitude, amour...) pour orienter la génération, ou laissez vide pour un rappel surprise.',
        position: 'top',
        offset: { x: 0, y: -130 },
    },
    {
        id: 'step-4',
        targetId: 'tuto-toolbar',
        title: '4. Personnalisez et partagez',
        description: 'Galerie, Design, changement de fond, Partage, Sauvegarde, Favoris — tous vos outils sont ici.',
        position: 'top',
        offset: { x: 0, y: -170 },
    },
    {
        id: 'step-5',
        targetId: 'tuto-generate',
        title: '5. Générez votre rappel',
        description: 'Appuyez ici (ou balayez vers le haut) pour obtenir un nouveau texte et une nouvelle image à chaque fois.',
        position: 'top',
        offset: { x: 0, y: -170 },
    },
];
